...
class Target_model { // initialized by File I/O 
public:
	int GPIO_CDM; 
	//GPIO_CDM ? 
	//Emebedded Calculate all values into 'Binary' 
	//ex> 0b111 
	//bool clock_gating // Connecting stats (on : 1 off : 0)
	//bool digital_enable; //Centralized Control System's access permission to target device. (yes : 1 no : 0) 
	//bool mode;   //Auto Control(1) Manual Control(0)

	int value; // element values of devices 
